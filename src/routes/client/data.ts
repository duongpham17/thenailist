export const data = {
    marketing: `Click here to recieve emails with promotions and offers`,
    policy: `In order to fulfil our obligations, we are required to maintain client records for the purpose of your treatments and will only be used for regulatory purposes. Please complete this form and if you would like to be kept up to date with offers and promotions, please select the subscribed to our newsletter box below.`,
    medical:  `By booking/having a treatment with us, you are confirming that you have provided or will provide all relevant information to us in relation to the medical matters listed below at the time of booking in relation to all those persons who will be receiving any treatments at the salon.
