...
const ReorderIndex = () => {
    ...
    const onReorder = async (index: number) => {
      ...
      const res1 = await api.patch("/terms", {...dataUpdated[index], timestamp: oldData.timestamp});
      const res2 = await api.patch("/terms", {...dataUpdated[reorderIndex], timestamp: newData.timestamp});
